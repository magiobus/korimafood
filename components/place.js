...
const Place = (props) => {
  ...
  const getRandomPlace = () => {
    ...
    setTimeout(function () {
      ...
      let newPlaces = _places.filter((_place) => {
        return _place.id != randomPlace.id;
      });
  ...
  const removePlaceFromSheet = async (id) => {
    try {
      ...
      if (response.status === 200) {
        toast({
          title: "Si se borro!",
          description: "Todo cool my friend",
          status: "sucess",
          duration: 5000,
          isClosable: true,
        });
  ...
  const getRandomLoadingPhrase = (loadingPhrases) => {
          ...
          {placeLoading ? (
            ...
            <>
              ...
              >
                <Flex direction="column" justify="center">
                  ...
                  >
                    <Link href={selectedPlace.mapsUrl} isExternal>
                      <Button variantColor="red" border="none" mb={4}>
                        ¿Cómo llegar? 🚖
                      </Button>
                    </Link>
                    ...
                    {selectedPlace.website && (
                      <Link href={selectedPlace.website} isExternal>
                        <Button variantColor="red" border="none" mx={4} mb={4}>
                          Website 💻
                        </Button>
                      </Link>
                    )}
                    ...
                    <a
                      ...
                      href="https://facebook.com/sharer/sharer.php?u=korimafood.com"
                      target="_blank"
                      rel="noopener"
                      aria-label="Facebook"
                    >
                    ...
                    <a
                      class="resp-sharing-button__link"
                      href="whatsapp://send?text=Encuentra%20un%20lugar%20distinto%20para%20comer%20en%20la%20ciudad%20de%20Chihuahua%2C%20Juarez%2C%20El%20Paso.%20%20korimafood.com"
                      target="_blank"
                      rel="noopener"
                      aria-label="WhatsApp"
                    >
                ...
                <Box mx={4}>
                  <Image
                    size={["100%", "250px", "250", "300px", "300px"]}
                    rounded="20px"
    ...
    return (
      ...
      >
        <Box
          ...
          p={5}
        >
          <Heading as="h1" color="red.600">
            Ya no tengo recomendaciones uwu
          </Heading>
        </Box>
      </Flex>
    );
